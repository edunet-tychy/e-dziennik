...
function zakladki($gr,$id)
{
   if($gr == 1)
   {
	  echo'<li><a href="plan_zajec.php?gr=1&id_ucz='.$id.'" title="Grupa I" class="zaj aktywna">Grupa I</a></li> ';
	  echo'<li><a href="plan_zajec.php?gr=2&id_ucz='.$id.'" title="Grupa II" class="zaj">Grupa II</a></li> ';
   } elseif($gr == 2)
   {
	  echo'<li><a href="plan_zajec.php?gr=1&id_ucz='.$id.'" title="Grupa I" class="zaj">Grupa I</a></li> ';
	  echo'<li><a href="plan_zajec.php?gr=2&id_ucz='.$id.'" title="Grupa II" class="zaj aktywna">Grupa II</a></li> ';
   }
}
