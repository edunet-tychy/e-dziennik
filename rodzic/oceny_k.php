...
<div id="kontener">
  ...
  <li><a href="oceny.php?id_ucz=<?php echo $id ;?>" title="Oceny semestr I" class="zaj">Semestr I</a></li>
  <li><a href="oceny_k.php?id_ucz=<?php echo $id ;?>" title="Oceny semestr II" class="zaj aktywna">Semestr II</a></li>
  </ul>
