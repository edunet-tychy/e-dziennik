...
//Dodanie wydarzenia	
  $("#dodajInformacje").click(function()
  {
...
<div id="kontener">
  ...
  <div id="czescGlowna">
    ...
    <div id="lista" class="zawartosc">
      <h3 id="nagRamka1">DODAJ NOWĄ INFORMCJĘ - KLASA <?php echo $klasa .' '. $sb; ?></h3>
      <form action="db_uwagi_dod.php" method="post" name="form" id="form">
        ...
        <tr>
          <td colspan="2" class="center-3"><input type="button" value="Dodaj informację" class="button" id="dodajInformacje"></td>
        </tr>
        </table>
      </form>
    </div>
