...
if($result = $mysqli->query("SELECT sem,id_user FROM ocen_sem WHERE id_kl='$id_kl'"))
{
...
if($result = $mysqli->query("SELECT zach FROM zach_sem WHERE id_kl='$id_kl'"))
{
  while($row=$result->fetch_object())
  {
	 $zach = $row->zach;
...
<div id="kontener">
  ...
  <div id="czescGlowna">
    <div id="lista" class="zawartosc">
      <h3 id="nagRamka">KLASYFIKACJA SEMESTR I - KLASA <?php echo $klasa . ' ' . $sb?></h3>
