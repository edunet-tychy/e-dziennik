...
<link href="../uczen/styl/styl.css" rel="stylesheet" type="text/css">
<link href="styl/styl.css" rel="stylesheet" type="text/css">
<script type="text/javascript">
$(document).ready(function()
{
	var url = 'db_oceny_uczen_pok.php';
	$("#user").load(url);
});
</script>
...
<div id="kontener">
  ...
  <div id="czescGlowna">
    <ul class="nawigacja_new">
      <li><a href="db_oceny_uczen.php" title="lista" class="zakladki aktywna" id="z_01">LISTA UCZNIÓW</a></li>
    </ul>
