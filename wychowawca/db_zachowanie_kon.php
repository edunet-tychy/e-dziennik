...
<div id="kontener">
  ...
  <div id="czescGlowna">
    <ul class="nawigacja">
      ...
      <li><a href="db_zachowanie_sem.php" title="zachowanie" class="zakladki" id="z_03">ZACHOWANIE - SEM I</a></li>
      <li><a href="db_zachowanie_kon.php" title="zachowanie" class="zakladki aktywna" id="z_03">ZACHOWANIE - SEM II</a></li>
    </ul>
    <div id="lista" class="zawartosc">
      <h3 id="nagRamka2">LISTA UCZNIÓW KLASY <?php echo $klasa . ' ' . $sb?></h3>
    </div>
      <form action="db_zachowanie2.php" method="post" name="form" id="form">
      <div id="zapis-2"></div>
      <div class="prawy-3">
      <input type="button" value="Zapisz oceny z zachowania" class="button" id="zapiszZachowanie2">
      </div>
      <div id="czesc">
