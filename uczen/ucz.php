  ...
  <div id="czescGlowna">
    ...
    <div id="datownik"><?php aktualnyKalendarz(); ?></div>
      ...
      <div id="panel">
        ...
        <div class="linka">
        <div class="icona"><a class="ocena" href="<?php echo $sem->getSem(); ?>"><img class="tooltip" src="image/icony/calendar.png" alt="Oceny klasy" title="Sprawdź swoje oceny"></a></div>
        <div class="info"><a class="ocena" href="<?php echo $sem->getSem(); ?>">OCENY</a></div>
        </div>
  
        <div class="linka">
        <div class="icona"><a class="temat" href="obecnosc.php?id_ucz=<?php echo $id_db; ?>"><img class="tooltip" src="image/icony/file_edit.png" alt="Frekwencja" title="Sprawdź swoją frekwencję"></a></div>
        <div class="info"><a class="temat" href="obecnosc.php">OBECNOŚĆ</a></div>
        </div>
        ...
        <div class="linka">
        <div class="icona"><a class="podrecznik" href="podreczniki.php"><img class="tooltip" src="image/icony/document_add.png" alt="Podręcznik" title="Zobacz listę obowiazujących podręczników"></a></div>
        <div class="info"><a class="podrecznik" href="podreczniki.php">PODRĘCZNIKI</a></div>
        </div>
  
        <div class="linka">
        <div class="icona"><a href="plan_zajec.php"><img class="tooltip" src="image/icony/clock.png" alt="Plan zajęć" title="Zobacz plan zajęć"></a></div>
        <div class="info"><a href="plan_zajec.php">PLAN ZAJĘĆ</a></div>
        </div>

        <div class="linka">
        <div class="icona"><a href="poczta.php"><img class="tooltip" src="image/icony/mail_write.png" alt="Poczta" title="Sprawdź pocztę"></a></div>
