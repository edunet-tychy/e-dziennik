...
<div id="kontener">
  ...
  <li><a href="oceny.php" title="Oceny semestr I" class="zaj aktywna">Semestr I</a></li>
  <li><a href="oceny_k.php" title="Oceny semestr II" class="zaj">Semestr II</a></li>
  </ul>
  <h3 id="nagRamka1">OCENY - SEMESTR I</h3>
  <?php	tabela($id_kl,$id);?>
  </div>
  <div id="stopka">
