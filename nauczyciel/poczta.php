...
include_once('../class/poczta_lista.class.php');
...
$bazaDzien = new dzien;
$bazaLista = new pocztaUczenRodzic;
...
<div id="kontener">
  ...
  <li><a href="#poz" title="sk_od" class="zaj aktywna">Skrzynka odbiorcza</a></li>
  <li><a href="#poz" title="sk_nad" class="zaj">Skrzynka nadawcza</a></li>
  </ul>
    <!-- SKRZYNKA NADAWCZA -->
    ...
    <tr><td class="dane-3">
        ...
        <option value="2">Dyrekcja</option>
        <option value="1">Administratorzy</option>
        <option value="3">Wychowawcy</option>
        <option value="4">Nauczyciele</option>
        <?php $bazaLista->uczen_rodzic($id); ?>
        </select>
    </td></tr>
