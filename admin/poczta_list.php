...
<link href="styl/styl_poczta.css" rel="stylesheet" type="text/css">
</head>
<body>
<?php
...
<div id="kontener">
  ...
  <h3 id="nagRamka1">ODPOWIEDŹ</h3>
    <p class="center-4">Dzisiaj jest <?php echo $bazaDz->dzw().', '. $baza->data(); ?> roku. Godz.: <?php echo $baza->godz(); ?>.</p>
    <form action="poczta_dod.php?dt=<?php echo $baza->dt(); ?>" method="post" name="form" id="form">
