...
include_once('../class/statystyka_srednie.class.php');
...
//Funkcja - View: Wykres średnich ocen klas
function interfejsKlasy($sem)
{
  $bazaSrednieKlas = new statystykaKlasySrednie;

  $tab = $bazaSrednieKlas->srKlasy($sem);
  $nr = 0;
  ...
  if($srednia != 0)
  {
	 ...
	 $myPicture->Render("image/oceny.png");	
	 
	 /* Wyświetlenie statystyki */
	 echo '<img src="image/oceny.png">';
  }
...
<div id="kontener">
  ...
  <div id="czescGlowna">
    <div id="lista" class="zawartosc">
      <h3 id="nagRamka4">WYKRES - ŚREDNIE OCENY KLAS</span></h3>
        <?php
          if($msc < 6)
          {
            interfejsKlasy('ocen_sem');
          } elseif ($msc > 5) {
            interfejsKlasy('ocen_rok');
          }
		?>
