...
include_once('../class/frekwencja_semestr.class.php');
...
class frekwencjaUczniow
{
  ...
  {
	$baza = new zapytanie;
	$bazaFrekSem = new frekwencjaSemestr;
	...
	if(isset($this->dane))
	{
	  foreach($this->dane as $this->uczen)
	  {
	   ...
	   $replace = array('Ś','Ł','Ź');
	   $this->uczen[0] = str_replace($search, $replace, $this->uczen[0]);
	   ...
	   //Miesiące
	   $bazaFrekMsc->frek_msc($this->id_ucz,'09',$mysqli);
	   $bazaFrekMsc->frek_msc($this->id_ucz,'10',$mysqli);
	   $bazaFrekMsc->frek_msc($this->id_ucz,'11',$mysqli);
	   $bazaFrekMsc->frek_msc($this->id_ucz,'12',$mysqli);
	   $bazaFrekMsc->frek_msc($this->id_ucz,'01',$mysqli);
	   
	   //Semestr
	   $bazaFrekSem->frek_sem($this->id_ucz,$mysqli);
...
<div id="kontener">
  ...
  <div id="czescGlowna">
    ...
    <ul class="nawigacja_sem2">
      <li><a href="frekwencja.php?id_kl=<?php echo $id_kl ;?>" title="Semestr I" class="sem aktywna" id="pod_1">SEMESTR I</a></li>
      <li><a href="frekwencja_rok.php?id_kl=<?php echo $id_kl ;?>" title="Semestr II" class="sem" id="pod_2">SEMESTR II</a></li>
    </ul>

      <table id="zestawienie-2">
      <tr><th colspan="19">ZESTAWIENIE FREKWENCJI ZA I SEMESTR  - KLASA <?php echo $klasa . ' ' . $sb?></th></tr>
      <tr>
        <th rowspan="3">Nr</th>
